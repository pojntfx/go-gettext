...
- [puregotk/purego](https://codeberg.org/puregotk/purego) allows us to call functions from `gettext` without the need for CGo.
- [puregotk/puregotk](https://codeberg.org/puregotk/puregotk) is what is commonly used with this library, and was very helpful for learning how to use purego.
